...
class Transport {
  ...
  bool get hasValidGeolocation =>
      ...
      endLatitude != 0 &&
      endLongitude != 0;
  bool get hasValidMeetingGeolocation =>
      meetingLatitude != 0 && meetingLongitude != 0;
  ...
  bool get isMeetingPointFarFromStartPoint =>
      (startLatitude - meetingLatitude).abs() > 0.1 &&
      (startLongitude - meetingLongitude).abs() > 0.1;
}
