...
class TripScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (context) =>
            TripBloc(context)..add(TripDataFetch(int.parse(tripId))),
          ...
          if (state is TripDataLoading) {
            ...
            return Scaffold(
              ...
              appBar: TripAppBar(
                ...
                imageUrl:
                    "${dotenv.env['API_ADDRESS']}/trips/${state.trip.id}/banner/download",
                userHasEditRights:
                    state.trip.currentUserHasEditingRights(context),
