...
class BackofficeLoginScreen extends StatefulWidget {
  const BackofficeLoginScreen({super.key});

  @override
  BackofficeLoginScreenState createState() => BackofficeLoginScreenState();
}

class BackofficeLoginScreenState extends State<BackofficeLoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Backoffice Login'),
      ),
      body: Center(
        child: Padding(
